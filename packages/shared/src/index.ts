...
export const userSchema = z.object({
    ...
    firstConnectedAt: z.coerce.date().nullable().optional(),
...
export const settingsSchema = z.object({
    ...
    reminderTime: z.string().regex(/^([0-9]|0\d|1\d|2[0-3]):([0-5]\d)$/).optional(),
    autoBillTime: z.string().regex(/^([0-9]|0\d|1\d|2[0-3]):([0-5]\d)$/).optional(),
    quietHoursStart: z.string().regex(/^([0-9]|0\d|1\d|2[0-3]):([0-5]\d)$/).optional(),
    quietHoursEnd: z.string().regex(/^([0-9]|0\d|1\d|2[0-3]):([0-5]\d)$/).optional(),
    ...
    qrisStaticImage: z.string().optional(),
